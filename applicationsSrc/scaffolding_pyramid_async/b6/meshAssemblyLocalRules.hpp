...
static const std::map <const LRKeyTuple, const Cell3DPosition> localMotionRules =
{
    ...
    { LRKeyTuple(0x800, Cell3DPosition(1, -1, 0), 1), Cell3DPosition(0,1, 0) }, // S_RZ 1
    { LRKeyTuple(0x140, Cell3DPosition(1, -1, 0), 2), Cell3DPosition(-1, -1, 1) }, // S_RZ 2
    { LRKeyTuple(0x142, Cell3DPosition(1, -1, 0), 2), Cell3DPosition(-1, -1, 1) }, // S_RZ 2 BIS
    ...
    { LRKeyTuple(0x181, Cell3DPosition(-1, 1, 0), 2), Cell3DPosition(-1, -1, 1) }, // S_LZ 2 BIS
    ...
    { LRKeyTuple(0x2C0, Cell3DPosition(0, 1, 0), 2), Cell3DPosition(-1, -1, 1) }, // Y1 2 BIS
    ...
    { LRKeyTuple(0x8C0, Cell3DPosition(1, 0, 0), 2), Cell3DPosition(-1, -1, 1) }, // X1 2 BIS
    ...
    { LRKeyTuple(0x404, Cell3DPosition(-(B2 - 1), -(B2 - 2), (B2 - 1)), 1), Cell3DPosition(-1, -1, 2) }, // Z_L_EPL1
    { LRKeyTuple(0x404, Cell3DPosition(-(B2 - 1), -(B2 - 2), (B2 - 1)), 2), Cell3DPosition(-1, 0, 1) }, // Z_L_EPL2
    { LRKeyTuple(0x021, Cell3DPosition(-(B2 - 1), -(B2 - 2), (B2 - 1)), 3), Cell3DPosition(-1, -1, 1) }, // Z_L_EPL3
    { LRKeyTuple(0x021, Cell3DPosition(-(B2 - 1), -(B2 - 2), (B2 - 1)), (B2 - 2)), Cell3DPosition(-1, -1, 2) }, // Z_L_EPL4
    // next 4 rules might be superfluous
    { LRKeyTuple(0x404, Cell3DPosition(-(B2 - 2), -(B2 - 1), (B2 - 1)), 1), Cell3DPosition(-1, -1, 2) }, // Z_R_EPL1
    { LRKeyTuple(0x404, Cell3DPosition(-(B2 - 2), -(B2 - 1), (B2 - 1)), 2), Cell3DPosition(0, -1, 1) }, // Z_R_EPL2
    { LRKeyTuple(0xA, Cell3DPosition(-(B2 - 2), -(B2 - 1), (B2 - 1)), 3), Cell3DPosition(-1, -1, 1) }, // Z_R_EPL3
    { LRKeyTuple(0xA, Cell3DPosition(-(B2 - 2), -(B2 - 1), (B2 - 1)), (B2 - 2)), Cell3DPosition(-1, -1, 2) }, // Z_R_EPL4
    ...
    { LRKeyTuple(0x005, Cell3DPosition(-(B2 - 2), -1, (B2 - 1)), 3), Cell3DPosition(-1, -1, 2) }, // RZ_EPL3
    { LRKeyTuple(0x402, Cell3DPosition(-(B2 - 2), -1, (B2 - 1)), (B2 - 2)), Cell3DPosition(0, 0, 1) }, // RZ_EPL4
    { LRKeyTuple(0x110, Cell3DPosition(-1, -1, (B2 - 1)), 1), Cell3DPosition(-1, -1, 2) }, //RevZ_EPL1
    { LRKeyTuple(0x110, Cell3DPosition(-1, -1, (B2 - 1)), 2), Cell3DPosition(-1, 0, 1) }, // RevZ_EPL2
    { LRKeyTuple(0xA0, Cell3DPosition(-1, -1, (B2 - 1)), 3), Cell3DPosition(-1, -1, 2) }, // RevZ_EPL3
    { LRKeyTuple(0x201, Cell3DPosition(-1, -1, (B2 - 1)), (B2 - 2)), Cell3DPosition(0, -1, 1) }, // RevZ_EPL4
    { LRKeyTuple(0x404, Cell3DPosition(-(B2 - 2), -(B2 - 2), (B2 - 1)), 1), Cell3DPosition(-1, -1, 2) }, // Z_EPL1
    { LRKeyTuple(0x404, Cell3DPosition(-(B2 - 2), -(B2 - 2), (B2 - 1)), 2), Cell3DPosition(0, -1, 1) }, // Z_EPL2
    { LRKeyTuple(0xA, Cell3DPosition(-(B2 - 2), -(B2 - 2), (B2 - 1)), 3), Cell3DPosition(-1, -1, 2) }, // Z_EPL3
